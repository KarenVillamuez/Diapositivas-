# -*- coding: utf-8 -*-
"""
Díptico Modelo a Modelo con las 3 métricas oficiales de la Tabla 3 del Paper:
1. Rechazo certero (sondas trampa): 28.6% vs 85.7%
2. Falso rechazo (preguntas válidas): 0.0% vs 7.1%
3. Tasa de Fallback total: 4.1% vs 18.4%
+ Veredicto Pedagógico en la base.
Distribución vertical armónica sin espacio muerto ni desbordamiento.
"""
import os
...
# -----------------------------------------------------------------------------
# VARIANTE 2D: Díptico Completo con las 3 Métricas de la Tabla 3 + Barras
# -----------------------------------------------------------------------------
HTML_V2_3METRICS = '''
<section class="slide s-white active" id="slide-14-3m">
  ...
  <div class="slide-content-area" style="justify-content: flex-start;">
    ...
    <h2 class="s-lead-question" style="font-size: 40px; font-weight: 800; margin-bottom: 18px; line-height: 1.2; color: var(--c-text-dark);">
...
<head>
  ...
  <title>Test Slide 14 Opcion 2 3-Metrics</title>
...
def main():
    variants = [
        ('slide_14_v2_3m.html', 'slide_14_v2_3m.png', HTML_V2_3METRICS),
    ]
