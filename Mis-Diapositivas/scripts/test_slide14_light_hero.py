# -*- coding: utf-8 -*-
"""
Test de opciones Hero en Fondo Claro para la Conclusión Pedagógica (Slide 14):
Resolviendo la observación del usuario: "los textos sobre fondos oscuros no se logran ver cuando se proyectan en sitios con mucha luz".
Todas las opciones usan fondo claro con tinta oscura (#110103 y #460811) de máximo contraste.
Alineadas a 1 sola línea limpia (sin palabras huérfanas).
"""
import os
...
# -----------------------------------------------------------------------------
# REMATE L1: Tarjeta Blanca con Marco Vinotinto de 2.5px y Acento Lateral de 10px
# -----------------------------------------------------------------------------
REMATE_L1 = '''
    <div style="background: #FFFFFF; border: 2.5px solid var(--c-wine-primary); border-left: 10px solid var(--c-wine-primary); padding: 14px 24px; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 4px 16px rgba(70, 8, 17, 0.06);">
      <span style="font-family: var(--font-sans); font-size: 22px; font-weight: 700; color: #110103;">
        <strong style="color: var(--c-wine-primary); font-family: var(--font-mono); font-size: 20px; font-weight: 800; letter-spacing: 1px; margin-right: 10px;">CONCLUSIÓN PEDAGÓGICA:</strong>Modelos con idéntica nota numérica exigen entornos de despliegue completamente distintos.
      </span>
...
# -----------------------------------------------------------------------------
# REMATE L2: Fondo Suave #FAF5F5 con Borde Vino de 2px + Badge en Cápsula Sólida
# -----------------------------------------------------------------------------
REMATE_L2 = '''
    <div style="background: #FAF5F5; border: 2px solid var(--c-wine-primary); padding: 14px 24px; display: flex; justify-content: space-between; align-items: center;">
      <div style="display: flex; align-items: center; gap: 14px;">
        <span style="font-family: var(--font-mono); font-size: 18px; font-weight: 800; color: var(--c-wine-primary); background: #F0E6E8; border: 1px solid #D8C4C7; padding: 4px 10px; letter-spacing: 1.5px; white-space: nowrap;">
          CONCLUSIÓN CLAVE
        </span>
        <span style="font-family: var(--font-sans); font-size: 22px; font-weight: 700; color: #110103;">
...
# -----------------------------------------------------------------------------
# REMATE L3: Doble Franja Vinotinto (Top y Bottom de 3px) sobre Fondo Suave
# -----------------------------------------------------------------------------
REMATE_L3 = '''
    <div style="background: #FAF5F5; border-top: 3px solid var(--c-wine-primary); border-bottom: 3px solid var(--c-wine-primary); padding: 14px 24px; display: flex; justify-content: space-between; align-items: center;">
      <span style="font-family: var(--font-sans); font-size: 22px; font-weight: 700; color: #110103;">
        <strong style="color: var(--c-wine-primary); font-family: var(--font-mono); font-size: 20px; font-weight: 800; letter-spacing: 1px; margin-right: 10px;">CONCLUSIÓN PEDAGÓGICA:</strong>Modelos con idéntica nota numérica exigen entornos de despliegue completamente distintos.
      </span>
      <span style="font-family: var(--font-mono); font-size: 19px; font-weight: 700; color: #5D4A4D; white-space: nowrap; margin-left: 20px;">
...
<head>
  ...
  <title>Test Slide 14 Light Hero</title>
...
def main():
    options = [
        ('slide_14_remate_l1.html', 'slide_14_remate_l1.png', REMATE_L1),
        ('slide_14_remate_l2.html', 'slide_14_remate_l2.png', REMATE_L2),
        ('slide_14_remate_l3.html', 'slide_14_remate_l3.png', REMATE_L3),
    ]
