# -*- coding: utf-8 -*-
"""
Test de opciones para resaltar la Conclusión Pedagógica en Slide 14:
- Opción H1: Franja Institucional con fondo suave (#FAF5F5), borde completo 2px vinotinto y badge 'CONCLUSIÓN PEDAGÓGICA'.
- Opción H2: Franja Institucional con borde lateral grueso de 6px vinotinto + tipografía destacada a 24px.
- Opción H3: Barra Hero en Vinotinto Institucional (#460811) con texto blanco y acento dorado (máximo impacto para auditorio).
"""
import os
...
# -----------------------------------------------------------------------------
# REMATE H1: Franja Institucional con Borde 2px y Badge
# -----------------------------------------------------------------------------
REMATE_H1 = '''
    <div style="background: #FAF5F5; border: 2px solid var(--c-wine-primary); padding: 14px 24px; display: flex; justify-content: space-between; align-items: center;">
      <div style="display: flex; align-items: center; gap: 16px;">
        <span style="font-family: var(--font-mono); font-size: 19px; font-weight: 800; color: var(--c-wine-primary); background: #F0E6E8; padding: 4px 12px; letter-spacing: 1.5px;">
...
# -----------------------------------------------------------------------------
# REMATE H2: Franja Suave con Borde Lateral Izquierdo de 6px y Texto 24px Bold
# -----------------------------------------------------------------------------
REMATE_H2 = '''
    <div style="background: #FAF5F5; border-left: 6px solid var(--c-wine-primary); padding: 14px 24px; display: flex; justify-content: space-between; align-items: center;">
      <span style="font-family: var(--font-sans); font-size: 23px; font-weight: 700; color: #110103;">
        <strong style="color: var(--c-wine-primary); font-family: var(--font-mono); letter-spacing: 1px; font-size: 21px; margin-right: 8px;">CONCLUSIÓN PEDAGÓGICA:</strong> Modelos con idéntica nota numérica exigen entornos de despliegue completamente distintos.
      </span>
...
# -----------------------------------------------------------------------------
# REMATE H3: Franja Vinotinto de Alto Impacto con Acento Dorado
# -----------------------------------------------------------------------------
REMATE_H3 = '''
    <div style="background: var(--c-wine-primary); color: #FFFFFF; padding: 14px 28px; display: flex; justify-content: space-between; align-items: center;">
      <span style="font-family: var(--font-sans); font-size: 23px; font-weight: 600; color: #FFFFFF;">
        <strong style="color: var(--c-gold); font-family: var(--font-mono); letter-spacing: 1.5px; font-size: 21px; margin-right: 12px;">CONCLUSIÓN PEDAGÓGICA:</strong> Modelos con idéntica nota numérica exigen entornos de despliegue completamente distintos.
      </span>
      <span style="font-family: var(--font-mono); font-size: 19px; font-weight: 700; color: rgba(255,255,255,0.75); white-space: nowrap; margin-left: 20px;">
        Tabla 3 (×4 semillas)
      </span>
    </div>
'''
...
<head>
  ...
  <title>Test Slide 14 Highlights</title>
...
def main():
    options = [
        ('slide_14_remate_h1.html', 'slide_14_remate_h1.png', REMATE_H1),
        ('slide_14_remate_h2.html', 'slide_14_remate_h2.png', REMATE_H2),
        ('slide_14_remate_h3.html', 'slide_14_remate_h3.png', REMATE_H3),
    ]
