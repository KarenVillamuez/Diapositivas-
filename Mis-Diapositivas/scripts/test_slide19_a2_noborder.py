...
# Opción A2-1: Marco Perimetral Fino Uniforme (1.5px solid #D8B8BE, sin borde lateral grueso), Badge 16px
HL_A2_1 = '''
        <!-- Ref 4: Muñoz-Gómez (Paper Base) A2-1 -->
        <div style="background: #FAF0F2; border: 1.5px solid #D8B8BE; border-radius: 0; padding: 13px 18px; margin-bottom: 8px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 5px;">
            <div style="display: flex; align-items: center; gap: 10px;">
              <span style="background: var(--c-wine-primary); color: #FFFFFF; font-family: var(--font-mono); font-size: 15px; font-weight: 900; letter-spacing: 1.2px; padding: 4px 12px; border-radius: 0;">
                ★ ARTÍCULO BASE DEL BENCHMARK
              </span>
              <span style="font-family: var(--font-mono); font-size: 13px; font-weight: 800; color: var(--c-wine-primary);">
                COLMAYOR CAUCA
              </span>
            </div>
            <span style="font-family: var(--font-mono); font-size: 14px; font-weight: 900; color: var(--c-wine-primary); background: #F0E2E5; padding: 3px 8px; border: 1px solid #D8B8BE;">
...
# Opción A2-2: Doble Regla Superior e Inferior (Estilo Slide 14/18, sin bordes laterales), Badge 16px
HL_A2_2 = '''
        <!-- Ref 4: Muñoz-Gómez (Paper Base) A2-2 -->
        <div style="background: #FAF0F2; border-top: 3px solid var(--c-wine-primary); border-bottom: 3px solid var(--c-wine-primary); border-radius: 0; padding: 13px 18px; margin-bottom: 8px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 5px;">
            <div style="display: flex; align-items: center; gap: 10px;">
              <span style="background: var(--c-wine-primary); color: #FFFFFF; font-family: var(--font-mono); font-size: 16px; font-weight: 900; letter-spacing: 1.2px; padding: 5px 14px; border-radius: 0;">
                ★ ARTÍCULO BASE DEL BENCHMARK
              </span>
            </div>
            <span style="font-family: var(--font-mono); font-size: 14px; font-weight: 900; color: var(--c-wine-primary); background: #F0E2E5; padding: 3px 8px; border: 1px solid #D8B8BE;">
...
# Opción A2-3: Caja Suave Tono Vino con Borde 1px muy sutil y Badge Prominente 17px
HL_A2_3 = '''
        <!-- Ref 4: Muñoz-Gómez (Paper Base) A2-3 -->
        <div style="background: #F6EAEC; border: 1px solid #DEC5C9; border-radius: 0; padding: 14px 20px; margin-bottom: 8px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
            <span style="background: var(--c-wine-primary); color: #FFFFFF; font-family: var(--font-mono); font-size: 16px; font-weight: 900; letter-spacing: 1.2px; padding: 5px 14px; border-radius: 0;">
              ★ ARTÍCULO BASE · ESTUDIO PRINCIPAL
            </span>
            <span style="font-family: var(--font-mono); font-size: 14px; font-weight: 900; color: var(--c-wine-primary); background: #FFFFFF; padding: 3px 10px; border: 1.5px solid var(--c-wine-primary);">
              REVISTA ENTRAMADO · 2026
            </span>
          </div>
          <div style="font-family: var(--font-sans); font-size: 24px; font-weight: 900; color: var(--c-wine-primary); margin-bottom: 3px;">
            Muñoz-Gómez, Y., Hoyos-Cerón, F., &amp; Caiza, J. (2026)
          </div>
          <div style="font-family: var(--font-sans); font-size: 21px; color: #110103; line-height: 1.35; font-weight: 600;">
            Portable RAG for offline tutoring: A benchmark on rural school hardware. <strong style="color: var(--c-wine-primary);">Revista Entramado</strong>, 22(2), 1–19. DOI: 10.18041/1900-3803.
...
<head>
  <meta charset="UTF-8">
  <title>Slide 19 A2 Refinements</title>
...
def main():
    variants = [
        ("slide19_a2_1_marco_uniforme", build_full_html(HL_A2_1)),
        ("slide19_a2_2_doble_regla", build_full_html(HL_A2_2)),
        ("slide19_a2_3_caja_suave_grande", build_full_html(HL_A2_3)),
    ]
