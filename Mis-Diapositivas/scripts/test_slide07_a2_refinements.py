# -*- coding: utf-8 -*-
"""
Generate refined variations of Option A2 for Slide 07 with larger, substantive tech chips.
"""
import os
...
# ==============================================================================
# VARIANTE A2-1: Chips Técnicos Ampliados a 14px con Texto Técnico Significativo
# ==============================================================================
BODY_A2_1 = f'''
    ...
    <div style="display: flex; flex-direction: column; gap: 26px;">
      ...
      <div style="display: flex; align-items: stretch; gap: 14px;">
        ...
        <div style="flex: 1; background: #FAF5F5; border-left: 6px solid var(--c-wine-primary); padding: 24px 22px; position: relative;">
          <!-- Chip ampliado (14px) -->
          <div class="tech-stamp" style="position: absolute; top: -16px; right: 12px; background: #FAF0F2; color: var(--c-wine-primary); border: 1.5px solid #D8B8BE; font-size: 13px; padding: 4px 10px; transform: rotate(-2.5deg); z-index: 10;">
            PDF CURRICULAR &bull; MEN
          </div>
        ...
        <div style="flex: 1; background: #FAF5F5; border-left: 6px solid var(--c-wine-primary); padding: 24px 22px; position: relative;">
          <!-- Chip ampliado (14px) -->
          <div class="tech-stamp" style="position: absolute; top: -16px; right: 12px; background: #FAF0F2; color: var(--c-wine-primary); border: 1.5px solid #D8B8BE; font-size: 13px; padding: 4px 10px; transform: rotate(2deg); z-index: 10;">
            BM25 + DENSO (RRF)
          </div>
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
            <span style="font-family: var(--font-mono); font-size: 18px; font-weight: 700; color: var(--c-wine-primary); letter-spacing: 1px;">
        ...
        <div style="flex: 1; background: #FAF5F5; border-left: 6px solid var(--c-red-accent); padding: 24px 22px; position: relative;">
          <!-- Chip ampliado (14px) -->
          <div class="tech-stamp" style="position: absolute; top: -16px; right: 12px; background: #FFF0F0; color: var(--c-red-accent); border: 1.5px solid #F0B8B8; font-size: 13px; padding: 4px 10px; transform: rotate(-2.5deg); z-index: 10;">
        ...
        <div style="flex: 1; background: #FAF5F5; border-left: 6px solid var(--c-gold); padding: 24px 22px; position: relative;">
          <!-- Chip ampliado (14px) en rojo acento de alto impacto -->
          <div class="tech-stamp" style="position: absolute; top: -16px; right: 12px; background: #C9101B; color: #FFFFFF; font-size: 13px; padding: 4px 10px; transform: rotate(3deg); z-index: 10; border: 1.5px solid #FFFFFF;">
      ...
      <div style="background: #FAF5F5; border: 2px solid var(--c-wine-primary); padding: 26px 36px; display: flex; align-items: center; gap: 36px; position: relative;">
        ...
        <div class="tech-stamp" style="position: absolute; top: -18px; right: 30px; background: #FAF0F2; color: var(--c-wine-primary); border: 2px solid var(--c-wine-primary); padding: 7px 18px; font-size: 14px; transform: rotate(-2.5deg); z-index: 5;">
          {ICON_USB}
...
# ==============================================================================
# VARIANTE A2-2: Chips Monumentales a 15px con Acentos Sólidos & Alto Impacto
# ==============================================================================
BODY_A2_2 = f'''
<section class="slide s-white active" id="slide-7">
  <header class="slide-header">
  ...
  <div class="slide-content-area" style="justify-content: center; padding-top: 10px; padding-bottom: 20px;">
    ...
    <div style="display: flex; flex-direction: column; gap: 26px;">
      ...
      <div style="display: flex; align-items: stretch; gap: 14px;">
        ...
        <!-- Paso 1 -->
        <div style="flex: 1; background: #FAF5F5; border-left: 6px solid var(--c-wine-primary); padding: 24px 22px; position: relative;">
          <!-- Chip Monumental (15px) con fondo y acento formal -->
          <div class="tech-stamp" style="position: absolute; top: -18px; right: 10px; background: #FAF0F2; color: var(--c-wine-primary); border: 2px solid var(--c-wine-primary); font-size: 14px; padding: 5px 12px; transform: rotate(-2.5deg); z-index: 10;">
            CORPUS &bull; MEN (PDF)
          </div>
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
            <span style="font-family: var(--font-mono); font-size: 18px; font-weight: 700; color: var(--c-wine-primary); letter-spacing: 1px;">
        ...
        <!-- Paso 2 -->
        <div style="flex: 1; background: #FAF5F5; border-left: 6px solid var(--c-wine-primary); padding: 24px 22px; position: relative;">
          <!-- Chip Monumental (15px) -->
          <div class="tech-stamp" style="position: absolute; top: -18px; right: 10px; background: #FAF0F2; color: var(--c-wine-primary); border: 2px solid var(--c-wine-primary); font-size: 14px; padding: 5px 12px; transform: rotate(2deg); z-index: 10;">
            BM25 + DENSO (RRF)
          </div>
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
            <span style="font-family: var(--font-mono); font-size: 18px; font-weight: 700; color: var(--c-wine-primary); letter-spacing: 1px;">
        ...
        <div style="flex: 1; background: #FAF5F5; border-left: 6px solid var(--c-red-accent); padding: 24px 22px; position: relative;">
          <!-- Chip Monumental (15px) -->
          <div class="tech-stamp" style="position: absolute; top: -18px; right: 10px; background: #FFF0F0; color: var(--c-red-accent); border: 2px solid var(--c-red-accent); font-size: 14px; padding: 5px 12px; transform: rotate(-2.5deg); z-index: 10;">
            CROSS-ENCODER MINILM
          </div>
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
            <span style="font-family: var(--font-mono); font-size: 18px; font-weight: 700; color: var(--c-red-accent); letter-spacing: 1px;">
        ...
        <!-- Paso 4 -->
        <div style="flex: 1; background: #FAF5F5; border-left: 6px solid var(--c-gold); padding: 24px 22px; position: relative;">
          <!-- Chip Monumental (15px) en Rojo Sólido y Borde Blanco -->
          <div class="tech-stamp" style="position: absolute; top: -18px; right: 10px; background: #C9101B; color: #FFFFFF; font-size: 14px; padding: 5px 14px; transform: rotate(3deg); z-index: 10; border: 2px solid #FFFFFF;">
            <code>llama.cpp</code> &bull; C/C++
          </div>
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
            <span style="font-family: var(--font-mono); font-size: 18px; font-weight: 700; color: #9A7200; letter-spacing: 1px;">
      ...
      <div style="background: #FAF5F5; border: 2px solid var(--c-wine-primary); padding: 26px 36px; display: flex; align-items: center; gap: 36px; position: relative;">
        ...
        <!-- Sello Asimétrico Flotante Tipo Estampa Técnica -->
        <div class="tech-stamp" style="position: absolute; top: -18px; right: 30px; background: #FAF0F2; color: var(--c-wine-primary); border: 2px solid var(--c-wine-primary); padding: 7px 18px; font-size: 15px; transform: rotate(-2.5deg); z-index: 5;">
          {ICON_USB}
          <span>PLUG &amp; PLAY &bull; PORTABLE EN USB 3.0</span>
        </div>
...
with sync_playwright() as p:
    ...
    # 1. Capture A2-1 (13px/14px)
    page.set_content(get_base_wrapper(BODY_A2_1))
    page.wait_for_timeout(600)
    path_a2_1 = os.path.join(output_dir, "slide_07_a2_1_large.png")
    page.screenshot(path=path_a2_1)
    print("Captured A2-1:", path_a2_1)
    
    # 2. Capture A2-2 (14px/15px Monumental)
    page.set_content(get_base_wrapper(BODY_A2_2))
    page.wait_for_timeout(600)
    path_a2_2 = os.path.join(output_dir, "slide_07_a2_2_monumental.png")
    page.screenshot(path=path_a2_2)
    print("Captured A2-2:", path_a2_2)
    
    browser.close()

print("A2 refinements generated successfully!")
