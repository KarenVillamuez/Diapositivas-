...
# Opción F1: R2 Rectangular Plano Enmarcado (1.5px borde perimetral vino suave, esquinas 100% a 90°)
BANNER_F1 = '''
    <div style="background: #FAF2F3; border: 1.5px solid #E2CCD1; border-radius: 0; padding: 18px 34px; display: flex; align-items: center; gap: 28px;">
...
# Opción F2: R2 Borde Superior Editorial (Estilo Slide 17 / Slide 03)
BANNER_F2 = '''
    <div style="background: #FAF5F5; border: 1px solid #E2D2D2; border-top: 4px solid var(--c-wine-primary); border-radius: 0; padding: 18px 34px; display: flex; align-items: center; gap: 28px;">
      <div style="display: flex; flex-direction: column; align-items: flex-start; white-space: nowrap; flex-shrink: 0;">
        <span style="font-family: var(--font-mono); font-size: 13px; font-weight: 800; color: var(--c-wine-primary); letter-spacing: 1.5px;">APORTE CENTRAL</span>
        <span style="font-family: var(--font-sans); font-size: 24px; font-weight: 900; color: #110103; line-height: 1.1; margin-top: 2px;">Tesis Defendida</span>
      </div>
...
# Opción F3: R2 Doble Regla Editorial Superior e Inferior (Estilo Remate Slide 14)
BANNER_F3 = '''
    <div style="background: #FAF5F5; border-top: 3.5px solid var(--c-wine-primary); border-bottom: 3.5px solid var(--c-wine-primary); border-radius: 0; padding: 18px 34px; display: flex; align-items: center; gap: 28px;">
      <div style="display: flex; flex-direction: column; align-items: flex-start; white-space: nowrap; flex-shrink: 0;">
        <span style="font-family: var(--font-mono); font-size: 13px; font-weight: 800; color: var(--c-wine-primary); letter-spacing: 1.5px;">APORTE CENTRAL</span>
        <span style="font-family: var(--font-sans); font-size: 24px; font-weight: 900; color: #110103; line-height: 1.1; margin-top: 2px;">Tesis Defendida</span>
      </div>
...
# Opción F5: R2 Cinta Invertida Vino Institucional Plano (#32060D, texto claro, máximo cierre)
BANNER_F5 = '''
    <div style="background: #32060D; border: none; border-radius: 0; padding: 18px 34px; display: flex; align-items: center; gap: 28px;">
      <div style="display: flex; flex-direction: column; align-items: flex-start; white-space: nowrap; flex-shrink: 0;">
        <span style="font-family: var(--font-mono); font-size: 13px; font-weight: 800; color: var(--c-gold); letter-spacing: 1.5px;">APORTE CENTRAL</span>
        <span style="font-family: var(--font-sans); font-size: 24px; font-weight: 900; color: #FFFFFF; line-height: 1.1; margin-top: 2px;">Tesis Defendida</span>
      </div>
      <div style="width: 2px; height: 42px; background: rgba(245, 194, 27, 0.4); flex-shrink: 0;"></div>
      <div style="font-family: var(--font-sans); font-size: 27px; color: #FFFFFF; line-height: 1.35; font-weight: 500;">
        <strong style="color: var(--c-gold);">Democratizar la IA educativa rural</strong> mediante hardware común, sin transferir jamás la <strong style="color: #FFB3BA;">soberanía pedagógica</strong> a los algoritmos.
      </div>
    </div>
'''

def build_html(banner):
    return f'''
...
<head>
  <meta charset="UTF-8">
  <title>Slide 18 Flat R2 Solutions</title>
...
def main():
    options = [
        ("slide18_f1_enmarcado_plano", build_html(BANNER_F1)),
        ("slide18_f2_borde_superior_plano", build_html(BANNER_F2)),
        ("slide18_f3_doble_regla_slide14", build_html(BANNER_F3)),
        ("slide18_f5_invertido_oscuro_plano", build_html(BANNER_F5)),
    ]
