...
SVG_SLOPEGRAPH_CLEAN = '''
<svg viewBox="0 0 740 330" style="width: 100%; height: auto; font-family: var(--font-sans);">
  <!-- Guías horizontales discretas -->
  <line x1="170" y1="50" x2="570" y2="50" stroke="#EAE0E1" stroke-width="1.5" stroke-dasharray="4 4" />
  <line x1="170" y1="110" x2="570" y2="110" stroke="#EAE0E1" stroke-width="1.5" stroke-dasharray="4 4" />
  <line x1="170" y1="170" x2="570" y2="170" stroke="#EAE0E1" stroke-width="1.5" stroke-dasharray="4 4" />
  <line x1="170" y1="230" x2="570" y2="230" stroke="#EAE0E1" stroke-width="1.5" stroke-dasharray="4 4" />
  <line x1="170" y1="290" x2="570" y2="290" stroke="#EAE0E1" stroke-width="1.5" stroke-dasharray="4 4" />

  <!-- Ejes de docentes -->
  <line x1="200" y1="35" x2="200" y2="305" stroke="#460811" stroke-width="3.5" />
  <line x1="540" y1="35" x2="540" y2="305" stroke="#C9101B" stroke-width="3.5" />

  <!-- Cabeceras de docentes con medias -->
  <text x="200" y="16" font-size="22" font-weight="800" fill="#460811" text-anchor="middle">Docente 1</text>
  <text x="200" y="34" font-size="16" font-weight="800" fill="#460811" text-anchor="middle" font-family="var(--font-mono)">MEDIA: 3.33</text>

  <text x="540" y="16" font-size="22" font-weight="800" fill="#C9101B" text-anchor="middle">Docente 2</text>
  <text x="540" y="34" font-size="16" font-weight="800" fill="#C9101B" text-anchor="middle" font-family="var(--font-mono)">MEDIA: 1.93</text>

  <!-- Escalas 1.0 a 5.0 -->
  <text x="180" y="56" font-size="17" fill="#8D7A7D" text-anchor="end" font-weight="700" font-family="var(--font-mono)">5.0</text>
  <text x="180" y="116" font-size="17" fill="#8D7A7D" text-anchor="end" font-weight="700" font-family="var(--font-mono)">4.0</text>
  <text x="180" y="176" font-size="17" fill="#8D7A7D" text-anchor="end" font-weight="700" font-family="var(--font-mono)">3.0</text>
  <text x="180" y="236" font-size="17" fill="#8D7A7D" text-anchor="end" font-weight="700" font-family="var(--font-mono)">2.0</text>
  <text x="180" y="296" font-size="17" fill="#8D7A7D" text-anchor="end" font-weight="700" font-family="var(--font-mono)">1.0</text>

  <text x="560" y="56" font-size="17" fill="#8D7A7D" font-weight="700" font-family="var(--font-mono)">5.0</text>
  <text x="560" y="116" font-size="17" fill="#8D7A7D" font-weight="700" font-family="var(--font-mono)">4.0</text>
  <text x="560" y="176" font-size="17" fill="#8D7A7D" font-weight="700" font-family="var(--font-mono)">3.0</text>
  <text x="560" y="236" font-size="17" fill="#8D7A7D" font-weight="700" font-family="var(--font-mono)">2.0</text>
  <text x="560" y="296" font-size="17" fill="#8D7A7D" font-weight="700" font-family="var(--font-mono)">1.0</text>

  <!-- 10 LÍNEAS REALES TABLA 4 -->
  <!-- Neutras (Gris suave 2px) -->
  <line x1="200" y1="170" x2="540" y2="250" stroke="#8D7A7D" stroke-width="2.5" opacity="0.45" />
  <line x1="200" y1="170" x2="540" y2="290" stroke="#8D7A7D" stroke-width="2.5" opacity="0.45" />
  <line x1="200" y1="110" x2="540" y2="270" stroke="#8D7A7D" stroke-width="2.5" opacity="0.45" />
  <line x1="200" y1="150" x2="540" y2="170" stroke="#8D7A7D" stroke-width="2.5" opacity="0.45" />

  <!-- Aprobadas Docente 1 (Vino 3.5px) -->
  <line x1="200" y1="130" x2="540" y2="270" stroke="#460811" stroke-width="3.5" opacity="0.9" />
  <line x1="200" y1="150" x2="540" y2="290" stroke="#460811" stroke-width="3.5" opacity="0.9" />
  <line x1="200" y1="110" x2="540" y2="290" stroke="#460811" stroke-width="4.5" opacity="0.95" />

  <!-- Aprobadas Docente 2 (Rojo 3.5px) -->
  <line x1="200" y1="170" x2="540" y2="210" stroke="#C9101B" stroke-width="3.5" opacity="0.9" />
  <line x1="200" y1="170" x2="540" y2="150" stroke="#C9101B" stroke-width="3.5" opacity="0.9" />
  <line x1="200" y1="170" x2="540" y2="150" stroke="#C9101B" stroke-width="3.5" opacity="0.9" />

  <!-- Puntos Docente 1 -->
  <circle cx="200" cy="110" r="7" fill="#460811" />
  <circle cx="200" cy="130" r="6" fill="#460811" />
  <circle cx="200" cy="150" r="6" fill="#460811" />
  <circle cx="200" cy="170" r="8" fill="#460811" />

  <!-- Puntos Docente 2 -->
  <circle cx="540" cy="150" r="7" fill="#C9101B" />
  <circle cx="540" cy="170" r="6" fill="#8D7A7D" />
  <circle cx="540" cy="210" r="6" fill="#C9101B" />
  <circle cx="540" cy="250" r="6" fill="#8D7A7D" />
  <circle cx="540" cy="270" r="7" fill="#460811" />
  <circle cx="540" cy="290" r="8" fill="#C9101B" />
</svg>
'''

# -------------------------------------------------------------
# OPCION S1: Split Asimétrico 55/45 con Tríada de Métricas Verticales
# -------------------------------------------------------------
CONTENT_S1 = f'''
...
# -------------------------------------------------------------
# OPCION S2: Díptico 50/50 Cuantitativo vs Cualitativo (Macro-Hero 0/10)
# -------------------------------------------------------------
CONTENT_S2 = f'''
    <h2 class="s-lead-question" style="font-size: 38px; font-weight: 800; margin: 0; line-height: 1.2; color: #2C0509;">
      La prueba docente: cuando los evaluadores humanos discrepan del algoritmo
...
<head>
  ...
  <title>Test Slide 15 Showcase</title>
...
def main():
    options = [
        ('slide_15_showcase_S1.html', 'slide_15_showcase_S1.png', CONTENT_S1),
        ('slide_15_showcase_S2.html', 'slide_15_showcase_S2.png', CONTENT_S2),
    ]
