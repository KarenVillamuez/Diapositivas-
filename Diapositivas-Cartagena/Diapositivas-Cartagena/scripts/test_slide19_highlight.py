...
# Variante D1: Fondo Marfil Cálido (#FFFCE8) con Borde Izquierdo Dorado (#B38600 5px) y Badge Sólido Dorado
HIGHLIGHT_D1 = '''
        <!-- Ref 4: Muñoz-Gómez (Paper Base) DESTACADO D1 -->
        <div style="background: #FFFDF0; border-left: 6px solid #B38600; border-top: 1px solid #EFE4BF; border-right: 1px solid #EFE4BF; border-bottom: 1px solid #EFE4BF; padding: 12px 18px; margin-bottom: 10px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px;">
            <div style="display: flex; align-items: center; gap: 8px;">
              <span style="background: #B38600; color: #FFFFFF; font-family: var(--font-mono); font-size: 12px; font-weight: 800; letter-spacing: 1px; padding: 3px 8px;">
            ...
            <span style="font-family: var(--font-mono); font-size: 13px; font-weight: 800; color: #B38600;">ENTRAMADO 2026</span>
          </div>
          <div style="font-family: var(--font-sans); font-size: 23px; font-weight: 900; color: #2C0509; margin-bottom: 2px;">
...
# Variante D2: Fondo Suave Vino (#FAF2F3) con Borde Izquierdo Vinotinto (var(--c-wine-primary) 6px) e Insignia Vinotinto
HIGHLIGHT_D2 = '''
        <!-- Ref 4: Muñoz-Gómez (Paper Base) DESTACADO D2 -->
        <div style="background: #FAF2F3; border-left: 6px solid var(--c-wine-primary); border-top: 1px solid #E8D0D5; border-right: 1px solid #E8D0D5; border-bottom: 1px solid #E8D0D5; padding: 12px 18px; margin-bottom: 10px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px;">
            <div style="display: flex; align-items: center; gap: 8px;">
              <span style="background: var(--c-wine-primary); color: #FFFFFF; font-family: var(--font-mono); font-size: 12px; font-weight: 800; letter-spacing: 1px; padding: 3px 8px;">
                ★ ARTÍCULO BASE DEL ESTUDIO
              </span>
              <span style="font-family: var(--font-mono); font-size: 12px; font-weight: 800; color: var(--c-wine-primary);">
                COLMAYOR CAUCA
              </span>
            </div>
            <span style="font-family: var(--font-mono); font-size: 13px; font-weight: 800; color: var(--c-wine-primary);">ENTRAMADO 2026 · OPEN ACCESS</span>
          </div>
          <div style="font-family: var(--font-sans); font-size: 23px; font-weight: 900; color: var(--c-wine-primary); margin-bottom: 2px;">
            Muñoz-Gómez, Y., Hoyos-Cerón, F., &amp; Caiza, J. (2026)
          </div>
          <div style="font-family: var(--font-sans); font-size: 21px; color: #110103; line-height: 1.35; font-weight: 600;">
            Portable RAG for offline tutoring: A benchmark on rural school hardware. <em>Revista Entramado</em>, 22(2), 1–19. DOI: 10.18041/1900-3803.
...
# Variante D3: Enmarcado Dorado Completo (Borde 2px Oro #B38600) con Fondo Crema y Micro-Anotación
HIGHLIGHT_D3 = '''
        <!-- Ref 4: Muñoz-Gómez (Paper Base) DESTACADO D3 -->
        <div style="background: #FFFDF2; border: 2px solid #D4A81E; padding: 12px 18px; margin-bottom: 10px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px;">
            <div style="display: flex; align-items: center; gap: 8px;">
              <span style="background: #D4A81E; color: #110103; font-family: var(--font-mono); font-size: 12px; font-weight: 900; letter-spacing: 1px; padding: 3px 8px;">
                ★ ARTÍCULO BASE · INVESTIGACIÓN PRINCIPAL
              </span>
            </div>
            <span style="font-family: var(--font-mono); font-size: 13px; font-weight: 800; color: #8A6700; background: #FFF3C4; padding: 2px 6px;">ENTRAMADO 2026</span>
          </div>
          <div style="font-family: var(--font-sans); font-size: 23px; font-weight: 900; color: #110103; margin-bottom: 2px;">
            Muñoz-Gómez, Y., Hoyos-Cerón, F., &amp; Caiza, J. (2026)
          </div>
          <div style="font-family: var(--font-sans); font-size: 21px; color: #110103; line-height: 1.35; font-weight: 600;">
            Portable RAG for offline tutoring: A benchmark on rural school hardware. <em>Revista Entramado</em>, 22(2), 1–19. DOI: 10.18041/1900-3803.
...
def build_content(highlight):
    panel_right = f'''
      ...
      <div style="background: #FAF5F5; border-top: 6px solid var(--c-red-accent); padding: 24px 30px; display: flex; flex-direction: column; justify-content: space-between;">
        <div style="display: flex; align-items: center; justify-content: space-between; border-bottom: 2px solid #EAE0E1; padding-bottom: 8px; margin-bottom: 10px;">
...
<head>
  <meta charset="UTF-8">
  <title>Slide 19 Base Paper Highlights</title>
...
def main():
    variants = [
        ("slide19_d1_dorado_elegante", build_content(HIGHLIGHT_D1)),
        ("slide19_d2_vino_institucional", build_content(HIGHLIGHT_D2)),
        ("slide19_d3_marco_oro_entramado", build_content(HIGHLIGHT_D3)),
    ]
