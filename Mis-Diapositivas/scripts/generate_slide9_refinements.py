...
# Opción A1: Línea tipográfica limpia (distribuida)
a1_bottom = '''
...
# Opción A2: Tarjeta / Barra Banner (Contenedor #FAF5F5 con borde wine)
a2_bottom = '''
...
options = {
    "slide_09_opcion_a1_linea.png": table_html + a1_bottom,
    "slide_09_opcion_a2_banner.png": table_html + a2_bottom,
}
...
print("Options A1 and A2 generated.")
