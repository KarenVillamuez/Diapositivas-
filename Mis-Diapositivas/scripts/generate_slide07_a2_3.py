# -*- coding: utf-8 -*-
"""
Generate Variante A2-3 with micro SVG icons inside each substantive chip for maximum visual interest.
"""
import os
...
# Micro SVGs for chips
CHIP_ICON_DOC = '''<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>'''
CHIP_ICON_BOLT = '''<svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>'''
CHIP_ICON_FILTER = '''<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>'''
CHIP_ICON_CHIP = '''<svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M6 2v2h12V2h2v2h2v2h-2v12h2v2h-2v2h-2v-2H6v2H4v-2H2v-2h2V6H2V4h2V2h2zm0 4v12h12V6H6zm2 2h8v8H8V8z"/></svg>'''
    ...
    <div style="display: flex; flex-direction: column; gap: 26px;">
      ...
      <div style="display: flex; align-items: stretch; gap: 14px;">
        ...
        <div style="flex: 1; background: #FAF5F5; border-left: 6px solid var(--c-wine-primary); padding: 24px 22px; position: relative;">
          <!-- Chip con micro-ícono SVG -->
          <div class="tech-stamp" style="position: absolute; top: -18px; right: 10px; background: #FAF0F2; color: var(--c-wine-primary); border: 2px solid var(--c-wine-primary); font-size: 13.5px; padding: 5px 12px; transform: rotate(-2.5deg); z-index: 10;">
            {CHIP_ICON_DOC}
            <span>CORPUS MEN &bull; PDF</span>
          </div>
        ...
        <div style="flex: 1; background: #FAF5F5; border-left: 6px solid var(--c-wine-primary); padding: 24px 22px; position: relative;">
          <!-- Chip con micro-ícono SVG -->
          <div class="tech-stamp" style="position: absolute; top: -18px; right: 10px; background: #FAF0F2; color: var(--c-wine-primary); border: 2px solid var(--c-wine-primary); font-size: 13.5px; padding: 5px 12px; transform: rotate(2deg); z-index: 10;">
            {CHIP_ICON_BOLT}
            <span>FUSI&Oacute;N RRF &bull; 60/40</span>
          </div>
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
            <span style="font-family: var(--font-mono); font-size: 18px; font-weight: 700; color: var(--c-wine-primary); letter-spacing: 1px;">
              PASO 02
        ...
        <div style="flex: 1; background: #FAF5F5; border-left: 6px solid var(--c-red-accent); padding: 24px 22px; position: relative;">
          <!-- Chip con micro-ícono SVG -->
          <div class="tech-stamp" style="position: absolute; top: -18px; right: 10px; background: #FFF0F0; color: var(--c-red-accent); border: 2px solid var(--c-red-accent); font-size: 13.5px; padding: 5px 12px; transform: rotate(-2.5deg); z-index: 10;">
            {CHIP_ICON_FILTER}
            <span>CROSS-ENCODER MINILM</span>
          </div>
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
        ...
        <div style="flex: 1; background: #FAF5F5; border-left: 6px solid var(--c-gold); padding: 24px 22px; position: relative;">
          <!-- Chip con micro-ícono SVG en Rojo Sólido y Borde Blanco -->
          <div class="tech-stamp" style="position: absolute; top: -18px; right: 10px; background: #C9101B; color: #FFFFFF; font-size: 13.5px; padding: 5px 14px; transform: rotate(3deg); z-index: 10; border: 2px solid #FFFFFF;">
            {CHIP_ICON_CHIP}
            <span><code>llama.cpp</code> &bull; C/C++</span>
          </div>
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
...
with sync_playwright() as p:
    ...
    page.set_content(get_base_wrapper(BODY_A2_3))
    page.wait_for_timeout(600)
    path_a2_3 = os.path.join(output_dir, "slide_07_a2_3_icons.png")
    page.screenshot(path=path_a2_3)
    print("Captured A2-3:", path_a2_3)
    browser.close()
