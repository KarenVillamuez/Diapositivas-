...
# ===========================================================================
# S1: Cabecera Monumental (Título 36px + Porcentaje 64px) + Texto Grande 28px
# ===========================================================================
CONTENT_S1 = '''
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; grid-template-rows: 1fr 1fr; gap: 24px; flex: 1; margin-top: 14px;">
      ...
      <div style="background: #FAF5F5; border-top: 8px solid #C51625; padding: 26px 36px; display: flex; flex-direction: column; justify-content: space-between;">
        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
          <div>
            <div style="font-family: var(--font-mono); font-size: 17px; font-weight: 800; color: #C51625; letter-spacing: 1.5px; margin-bottom: 4px;">
              01 · EL RIESGO OCULTO
            </div>
        ...
        <div style="font-family: var(--font-sans); font-size: 28px; color: #110103; line-height: 1.36; font-weight: 600;">
          El puntaje premia copiar del libro, pero encubre que el tutor inventa falsedades cuando no sabe la respuesta.
        </div>
      </div>

      <!-- C2: La Regla Metodológica -->
      <div style="background: #FAF5F5; border-top: 8px solid #4A3B3D; padding: 26px 36px; display: flex; flex-direction: column; justify-content: space-between;">
        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
          <div>
            <div style="font-family: var(--font-mono); font-size: 17px; font-weight: 800; color: #4A3B3D; letter-spacing: 1.5px; margin-bottom: 4px;">
      ...
      <div style="background: #FAF5F5; border-top: 8px solid var(--c-wine-primary); padding: 26px 36px; display: flex; flex-direction: column; justify-content: space-between;">
        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
          <div>
            <div style="font-family: var(--font-mono); font-size: 17px; font-weight: 800; color: var(--c-wine-primary); letter-spacing: 1.5px; margin-bottom: 4px;">
      ...
      <div style="background: #FAF5F5; border-top: 8px solid var(--c-red-accent); padding: 26px 36px; display: flex; flex-direction: column; justify-content: space-between;">
        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
          <div>
            <div style="font-family: var(--font-mono); font-size: 17px; font-weight: 800; color: var(--c-red-accent); letter-spacing: 1.5px; margin-bottom: 4px;">
        ...
        <div style="border-top: 2px solid #E5D5D5; margin: 12px 0 14px 0;"></div>
        <div style="font-family: var(--font-sans); font-size: 28px; color: #110103; line-height: 1.36; font-weight: 600;">
          En clase prima mantener el ritmo pedagógico: no frena al grupo y el docente modera y corrige en vivo.
        </div>
      </div>
...
# ===========================================================================
# S2: Columna Lateral Heroica Pura (Split 68% / 32%) con Todo a Gran Escala
# Llena la tarjeta por completo a lo ancho y a lo alto sin ningún hueco muerto.
# ===========================================================================
CONTENT_S2 = '''
    <h2 class="s-lead-question" style="font-size: 38px; font-weight: 800; margin: 0; line-height: 1.2; color: #2C0509;">
      Apego al texto no es aprendizaje: criterios para auditar y desplegar tutores
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; grid-template-rows: 1fr 1fr; gap: 24px; flex: 1; margin-top: 14px;">
      ...
      <!-- C1 -->
      <div style="background: #FAF5F5; border-top: 8px solid #C51625; padding: 26px 34px; display: grid; grid-template-columns: 1fr 200px; gap: 26px; align-items: center;">
        <div>
          <div style="font-family: var(--font-mono); font-size: 16px; font-weight: 800; color: #C51625; letter-spacing: 1.5px; margin-bottom: 6px;">
            01 · EL RIESGO OCULTO
          </div>
          <div style="font-family: var(--font-sans); font-size: 36px; font-weight: 900; color: #110103; margin-bottom: 10px;">
            La Falacia del Promedio
          </div>
          <div style="font-family: var(--font-sans); font-size: 26px; color: #110103; line-height: 1.38; font-weight: 600;">
            Premia copiar del libro, pero encubre que el tutor inventa falsedades cuando no sabe la respuesta.
          </div>
        </div>
        <div style="border-left: 3px solid #E5D5D5; padding-left: 24px; text-align: center;">
          <div style="font-family: var(--font-mono); font-size: 64px; font-weight: 900; color: #C51625; line-height: 1;">0.795</div>
          <div style="font-family: var(--font-mono); font-size: 15px; font-weight: 800; color: #5D4A4D; margin-top: 6px; letter-spacing: 0.5px;">APEGO ENGAÑOSO</div>
        </div>
      </div>

      <!-- C2 -->
      <div style="background: #FAF5F5; border-top: 8px solid #4A3B3D; padding: 26px 34px; display: grid; grid-template-columns: 1fr 200px; gap: 26px; align-items: center;">
        <div>
        ...
        <div style="border-left: 3px solid #E5D5D5; padding-left: 24px; text-align: center;">
          ...
          <div style="font-family: var(--font-mono); font-size: 15px; font-weight: 800; color: #5D4A4D; margin-top: 6px; letter-spacing: 0.5px;">DIMENSIONES</div>
        </div>
      </div>

      <!-- C3 -->
      <div style="background: #FAF5F5; border-top: 8px solid var(--c-wine-primary); padding: 26px 34px; display: grid; grid-template-columns: 1fr 200px; gap: 26px; align-items: center;">
        <div>
          ...
          <div style="font-family: var(--font-sans); font-size: 36px; font-weight: 900; color: var(--c-wine-primary); margin-bottom: 10px;">
            Qwen2.5-3B: Certeza
          </div>
          <div style="font-family: var(--font-sans); font-size: 26px; color: #110103; line-height: 1.38; font-weight: 600;">
            En soledad no hay profesor que corrija. Admitir ignorancia es pedagógico; inventar deseduca al alumno.
          </div>
        </div>
        <div style="border-left: 3px solid #E5D5D5; padding-left: 24px; text-align: center;">
          <div style="font-family: var(--font-mono); font-size: 68px; font-weight: 900; color: var(--c-wine-primary); line-height: 1;">85.7%</div>
          <div style="font-family: var(--font-mono); font-size: 15px; font-weight: 800; color: var(--c-wine-primary); margin-top: 6px; letter-spacing: 0.5px;">RECHAZO CERTERO</div>
        </div>
      </div>

      <!-- C4 -->
      <div style="background: #FAF5F5; border-top: 8px solid var(--c-red-accent); padding: 26px 34px; display: grid; grid-template-columns: 1fr 200px; gap: 26px; align-items: center;">
        <div>
          ...
          <div style="font-family: var(--font-sans); font-size: 36px; font-weight: 900; color: var(--c-red-accent); margin-bottom: 10px;">
            Phi-4-mini: Fluidez
          </div>
          <div style="font-family: var(--font-sans); font-size: 26px; color: #110103; line-height: 1.38; font-weight: 600;">
            En clase prima no frenar el ritmo: interacción continua y el docente modera y corrige en vivo.
          </div>
        </div>
        <div style="border-left: 3px solid #E5D5D5; padding-left: 24px; text-align: center;">
          <div style="font-family: var(--font-mono); font-size: 68px; font-weight: 900; color: var(--c-red-accent); line-height: 1;">0.0%</div>
          <div style="font-family: var(--font-mono); font-size: 15px; font-weight: 800; color: var(--c-red-accent); margin-top: 6px; letter-spacing: 0.5px;">BLOQUEOS DIÁLOGO</div>
        </div>
      </div>
...
<head>
  ...
  <title>Test Slide 17 Perfect Scale</title>
...
def main():
    options = [
        ('slide_17_c3_scale_s1.html', 'slide_17_c3_scale_s1.png', CONTENT_S1),
        ('slide_17_c3_scale_s2.html', 'slide_17_c3_scale_s2.png', CONTENT_S2),
    ]
